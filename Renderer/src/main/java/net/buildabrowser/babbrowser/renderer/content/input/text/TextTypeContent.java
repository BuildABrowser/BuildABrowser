...
public class TextTypeContent extends InstrinsicSizedInputTypeContent {
  ...
  private final InputTextController textController;
  ...
  public UnmanagedBoxFragment<?> layout(
    ...
    LoadedFont font = rootBox.layoutContext().font();
    textController.updateMetrics(font.metrics());
    textController.updateFont(font);
